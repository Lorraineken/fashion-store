...
const AboutUs = () => {
  return (
    <div className="card">
      ...
      At our fashion website, we understand that shopping for fashion items can be overwhelming. That's why we provide personalized style advice and assistance to help you find exactly what you're looking for. We offer free shipping on all orders and hassle-free returns to ensure that you have a stress-free shopping experience. We are passionate about fashion and committed to bringing you the best products and services possible. Thank you for choosing our fashion website as your go-to source for all your fashion needs.
      </p>
    </div>
  );
};
